...
<p>Audio Only <input type="checkbox" value="yes" id="audioonly" <?php if (isset($_GET['audioonly'])) { if ($_GET['audioonly']=="true" || $_GET['audioonly']==null) { echo "checked"; } } if (isset($_GET['audioonly'])==false) { echo "checked"; } ?>></p>
