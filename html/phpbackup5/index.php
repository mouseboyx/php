...
<p><input type="text" name="q" size="55" value="<?php echo htmlspecialchars($_GET['lq']); ?>"></p>


<p><input type="radio" name="moveordl" value="move"<?php if ($_GET['move']=="move") { echo " checked"; } ?>> Move to music</p>
<p><input type="radio" name="moveordl" value="dl"<?php if ($_GET['move']=="dl") { echo " checked"; } ?>> Download</p>

<p><input type="checkbox" name="audioonly" value="yes" <?php if ($_GET['audioonly']=="yes") { echo "checked"; } ?>> Audio only</p>
...
<div>
	...
	<p><input type="radio" name="moveto" value="downloads" <?php if ($_GET['moveto']=="downloads") { echo "checked"; } ?>> Move to Downloads</p>
	<p><input type="radio" name="moveto" value="music" <?php if ($_GET['moveto']=="music") { echo "checked"; } ?>> Move to Music</p>
	<p><input type="radio" name="moveto" value="youtube" <?php if ($_GET['moveto']=="youtube") { echo "checked"; } ?>> Download</p>
	<p><input type="checkbox" name="audioonly" value="yes" <?php if ($_GET['audioonly']=="yes") { echo "checked"; } ?>> Audio Only</p>
	<input type="submit">
	</form>
</div>
